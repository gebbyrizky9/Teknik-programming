...
public class Borrower {
    ...
    // =========================
    // DOMAIN BEHAVIOR (Refactor Step 2 - Fowler: Move Method)
    // =========================
    // Business logic dipindahkan dari service ke domain
    // agar Borrower "tahu" sendiri apakah dia boleh mengajukan loan
